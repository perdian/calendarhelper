...
public class GoogleAuthorizationCodeSupplier implements Supplier<String> {
    ...
    public GoogleAuthorizationCodeSupplier(GoogleApplicationCredentials googleApplicationCredentials, NetHttpTransport googleHttpTransport, JsonFactory googleJsonFactory) {
    ...
    public String get() {
        ...
        try (GoogleAuthorizationCodeCallbackServer callbackServer = new GoogleAuthorizationCodeCallbackServer(authorizationCodeFuture)) {
            ...
            try (GoogleAuthorizationCodeUserDialog userDialog = new GoogleAuthorizationCodeUserDialog(loginUrl)) {
